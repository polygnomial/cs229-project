...
def main(args):
    ...
    if args.model_type == 'encoderfeature':
        ...
        ], base_optimizer=optim.Adam, weight_decay=args.weight_decay)
    elif args.model_type == 'segformer':
        optimizer = SAM(model.parameters(), base_optimizer=optim.Adam, lr=args.learning_rate, weight_decay=args.weight_decay)
    else:
